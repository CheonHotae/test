            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">영화목록-MovieList.jsp</h1>
                        
                    </div>

                    <!-- Content Row -->
 						<div class="row" style="margin: auto; padding: 10px; justify-content: center;">
 							...
 							<div class="col-3" style="border: 1px solid black; padding: 10px">
 								...
 								<img alt="${movie.mvname }"  src="${movie.mvposter }"  style="width: 100%; height: 100%; object-fit:cover;">
 								</a>
 								...
 								<div style="color : gold; padding:10px">
 									...
 									추천 : ${movie.goodRecommend } & 비추천 : ${movie.badRecommend } <br>
 									예매율 : ${movie.reservationRatio } %
