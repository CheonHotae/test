...
<nav
	...
	<!-- Topbar Search -->
	<form
		action="movieSelect" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" >
		<div class="input-group">
			<input type="text" class="form-control bg-light border-0 small"
				placeholder="검색 단어 입력 .." aria-label="Search"
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow d-sm-none"><a
			...
			<div
				...
				<form class="form-inline mr-auto w-100 navbar-search" action="movieSelect" >
					<div class="input-group">
						<input type="text" class="form-control bg-light border-0 small"
							placeholder="검색 단어 입력 .." aria-label="Search"
							aria-describedby="basic-addon2" name="searchName">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2  d-lg-inline text-gray-600 small">${sessionScope.loginId}
					</span> 
				<c:choose>
			...
			<div
				...
				<a class="dropdown-item" href="memberView"> <i
					...
					class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> 영화예매
				</a> <a class="dropdown-item" href="#"> <i
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">"로그아웃"을 선택하면 로그아웃 됩니다.
				</div>
...
<!-- 예약정보 출력 Model -->
<div class="modal fade" id="reInfoModal" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">예매되었습니다.</h5>
				<button class="close" type="button" data-dismiss="modal"
					aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
					...
					<div class="row">
						<div class="col-5">
							<div class="text-gray-900">
								<img id="reserveMsg_mvposter"class="img-fluid" alt="" src="">
							</div>
						</div>
						
						<div class="col-7">
							<div class="text-gray-900">
								<div class="p-2 font-weight-bold " id="reserveMsg_recode"></div>
								<div class="p-2 font-weight-bold " id="reserveMsg_mvname"></div>
								<div class="p-2 font-weight-bold " id="reserveMsg_thname"></div>
								<div class="p-2 font-weight-bold " id="reserveMsg_scdate"></div>
								<div class="p-2 font-weight-bold " id="reserveMsg_reamount"></div>
